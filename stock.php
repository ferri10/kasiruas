                                    ...
                                    <tbody>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <input type="text" name="namaproduk" class="form-control" placeholder="Nama Produk" value="<?= $namaproduk; ?>">
                                                    ...
                                                    <!-- <input type="numn" name="stock" class="form-control mt-2" placeholder="Stock Awal"> -->
                                                    <input type="number" name="harga" class="form-control mt-2" placeholder="Harga Produk" value="<?= $harga; ?>" min="1" required>
